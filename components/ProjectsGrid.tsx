...
const ProjectsGrid: React.FC = () => {
  const photos = [
    ...
    { url: '/foto2.webp', alt: 'Aston Martin DB11', span: 'md:col-span-2 md:row-span-1' },
    { url: '/foto3.webp', alt: 'Tesla Model S Plaid', span: 'md:col-span-2 md:row-span-1' },
    { url: '/foto4.webp', alt: 'McLaren 720S', span: 'md:col-span-2 md:row-span-1' },
    // Fix: Added missing opening quote for 'alt' value
    { url: '/foto5.webp', alt: 'Audi R8 V10', span: 'md:col-span-1 md:row-span-2' },
    { url: '/foto6.webp', alt: 'Rolls-Royce Ghost', span: 'md:col-span-2 md:row-span-2' },
    { url: '/foto7.webp', alt: 'Bentley Continental', span: 'md:col-span-1 md:row-span-1' },
    { url: '/foto1.webp', alt: 'Corvette C8', span: 'md:col-span-2 md:row-span-1' },
    { url: '/foto2.webp', alt: 'Shelby Cobra', span: 'md:col-span-1 md:row-span-1' },
    { url: '/foto3.webp', alt: 'BMW M8', span: 'md:col-span-1 md:row-span-1' },
    { url: '/foto4.webp', alt: 'Jaguar F-Type', span: 'md:col-span-1 md:row-span-1' },
  ];
