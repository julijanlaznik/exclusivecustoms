...
const ProjectsGrid: React.FC = () => {
  const photos = [
    ...
    { url: '/foto8.webp', alt: 'Porsche 911 GT3', span: 'md:col-span-2 md:row-span-2' },
    { url: '/foto9.webp', alt: 'Lamborghini Huracán', span: 'md:col-span-1 md:row-span-1' },
    { url: '/foto10.webp', alt: 'Luxury Showroom', span: 'md:col-span-1 md:row-span-1' },
    { url: '/foto11.webp', alt: 'BMW M4 Competition', span: 'md:col-span-2 md:row-span-1' },
